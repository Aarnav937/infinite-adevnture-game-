  ...
  return (
    <div className="flex flex-col gap-4 h-full">
      <div className="aspect-video bg-gray-800 rounded-lg border border-gray-700 flex items-center justify-center overflow-hidden relative">
        {isImageLoading ? (
          <>
            <div className="w-full h-full bg-gray-700 relative overflow-hidden shimmer-effect"></div>
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 text-gray-300 z-10">
              <p className="text-lg font-medium">Conjuring a vision...</p>
            </div>
          </>
        ) : (
          imageUrl && <img src={imageUrl} alt="Current scene" className="w-full h-full object-cover" loading="lazy" />
        )}
      </div>
